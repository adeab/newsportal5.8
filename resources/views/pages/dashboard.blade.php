                        ...
                        <div class="MS-content">
                            <div class="item">
                                <div class="imgTitle">
                                    ...
                                    <img src="{{ asset('frontend/img/news1.png')}}" alt="" />
                                    <img class="img2" src="{{ asset('frontend/img/user.png')}}">
                                </div>
                                <div class="text_slide">
                                  <h6>আখতারুজ্জামান আজাদ </h6>
                                 <p>এক তরুণ ব্রিটিশ ভ্লগারের চোখে বাংলাদেশ</p>
                            ...
                            <div class="item">
                                <div class="imgTitle">
                                    ...
                                    <img src="{{ asset('frontend/img/news2.jpg')}}" alt="" />
                                     <img class="img2" src="{{ asset('frontend/img/user2.jpg')}}">
                                </div>
                                <div class="text_slide">
                                  <h6>আখতারুজ্জামান আজাদ </h6>
                                 <p>এক তরুণ ব্রিটিশ ভ্লগারের চোখে বাংলাদেশ</p>
                            ...
                            <div class="item">
                                <div class="imgTitle">
                                    ...
                                    <img src="{{ asset('frontend/img/news3.jpg')}}" alt="" />
                                     <img class="img2" src="{{ asset('frontend/img/user.png')}}">
                                </div>
                                <div class="text_slide">
                                 <h6>আখতারুজ্জামান আজাদ </h6>
                            ...
                            <div class="item">
                                <div class="imgTitle">
                                    ...
                                    <img src="{{ asset('frontend/img/news4.jpg')}}" alt="" />
                                     <img class="img2" src="{{ asset('frontend/img/user.png')}}">
                                </div>
                               <div class="text_slide">
                                 <h6>আখতারুজ্জামান আজাদ </h6>
                 ...
                 <div class="col-md-3 padding0">
                   ...
                   <div class="right_tab_menu">
                     <ul>
                       ...
                       <li style="padding: 12px;border: none;">
                    <a href="#" style="color:red">সব  এক সাথে দেখুন -></a>
                  </li>
                     </ul>
                   </div>
                 </div>
